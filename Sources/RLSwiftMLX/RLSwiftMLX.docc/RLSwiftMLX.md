...
tensor alias, validated observation-batch metadata, and observation-encoder
protocol that were intentionally kept out of the core `RLSwift` target so
non-MLX builds can use the reinforcement-learning and robot-control types
