...
Run SwiftRL policies through NVIDIA TensorRT on Linux.

## Overview

SwiftRLTensorRT is the opt-in NVIDIA backend for SwiftRL. When the
...
development remains focused on SwiftRL and MLX while DGX, workstation, and
...
use SwiftRL/MLX for local inference, adaptation, simulation, telemetry, or
evaluation.
...
- convert continuous outputs into SwiftRL robot actions.
...
through SwiftRLTensorRT for low-latency inference.
