...
Use MLX tensors with SwiftRL.

## Overview

SwiftRLMLX is the opt-in MLX backend for SwiftRL. It contains the public MLX
tensor alias and observation-encoder protocol that were intentionally kept out of
the core `SwiftRL` target so non-MLX builds can use the reinforcement-learning
